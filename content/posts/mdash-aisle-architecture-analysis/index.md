...
![MDASH 五阶段流水线](assets/figure-01-mdash-five-stage-pipeline.png)
...
![MDASH 多模型集成](assets/figure-02-01-mdash-model-ensemble.png)

**2. 可扩展插件架构**


![MDASH 可扩展插件架构](assets/figure-02-mdash-plugin-architecture.png)


**3. 模型代际迁移设计**


![MDASH 模型代际迁移设计](assets/figure-03-mdash-model-migration.png)
...
![CVE-2026-33827 攻击路径](assets/figure-04-tcpip-attack-path.png)
...
![CVE-2026-33824 双重释放机制](assets/figure-05-ikeext-double-free-mechanism.png)


**跨越六个文件的漏洞链**：


![IKEEXT 跨文件漏洞链](assets/figure-06-ikeext-cross-file-chain.png)
...
![CyberGym 失败案例结构性分析](assets/figure-chap2-CyberGym-Failure-Cases-Structural-Analysis.png)
...
![AISLE 端到端流水线](assets/figure-07-aisle-end-to-end-pipeline.png)
...
![小模型反超：OWASP 假阳性实验中的能力锯齿性](assets/figure-chap3-Capability-Reversal-in-OWASP-False-Positive-Classification.png)
...
![有效载荷约束问题](assets/figure-chap3-payload-constraint-solution-comparison.png)
...
![Microsoft MDASH vs AISLE 架构总览](assets/figure-08-mdash-vs-aisle-overview.png)


#### MDASH 多模型集成架构


![MDASH 多模型集成架构](assets/figure-09-mdash-multi-model-integration.png)


#### AISLE 经济学模型


![AISLE 经济学模型](assets/figure-10-aisle-economics-model.png)
...
!["锯齿性"的本质](assets/figure-chap5-jagged-frontier-of-model-capabilities.png)
...
![The Overlooked Risk in the Mythos Narrative](assets/figure-chap6-overlooked-risk-of-mythos-narrative.png)
